...
the marbles that are 1 and 2 marbles clockwise of the current marble. (When the circle is
large enough, this means that there is one marble between the marble that was just placed
and the current marble.) The marble that was just placed then becomes the current marble.
...
[2]  0 (2) 1                    len=2, insert_pos = 1, current_pos <-- 1
[3]  0  2  1 (3)                len=3, insert_pos = 4, current_pos <-- 4
[4]  0 (4) 2  1  3              len=4, insert_pos = 1
[5]  0  4  2 (5) 1  3
[6]  0  4  2  5  1 (6) 3
[7]  0  4  2  5  1  6  3 (7)
[8]  0 (8) 4  2  5  1  6  3  7
